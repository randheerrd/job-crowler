      ...
      <div className="w-full max-w-[340px]">
        <div className="mb-7">
          <svg width="22" height="22" viewBox="0 0 60 60" fill="none" className="mb-5 text-primary-500">
            <defs><clipPath id="login-clip"><circle cx="28" cy="30" r="24"/></clipPath></defs>
            <circle cx="28" cy="30" r="26" stroke="currentColor" strokeWidth="3.5"/>
            <circle cx="37" cy="30" r="19" stroke="currentColor" strokeWidth="3.5" clipPath="url(#login-clip)"/>
            <circle cx="46" cy="30" r="11" stroke="currentColor" strokeWidth="3.5" clipPath="url(#login-clip)"/>
          </svg>
          <h1 className="text-[17px] font-semibold text-gray-900 mb-1">Sign in to Calos</h1>
